...
- mvn-compiler-version set to 3.15.0
- mvn-source-version set to 3.4.0
...
- build-helper-maven-plugin-version 3.6.1
...
- lombok-version set to 1.18.38 (jdk 24 support)

## [1.7.3] - 2025-03-16

### Changed

- fj-test-helper version set to 1.0.0
...
- mvn-plugin-plugin-version set to 3.15.1
- mvn-formatter-plugin-version 2.25.0

## [1.7.1] - 2024-12-26

### Fixed

- formatter-maven-plugin will be run only if built with jdk 17+
...
- mvn-surefire-version set to 3.5.0
